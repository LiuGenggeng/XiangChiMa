        ...
        (function( $ ){
            ...
            //$(function() {
                ...
                uploader.on( 'uploadBeforeSend', function( block, data ) {
                    ...
                    var sessionid = sessionStorage.getItem("sessionid");
                    var weui_textarea_1 = $(".weui_textarea_1").val();
                    var description = $(".weui_textarea_2").val();
                    var price = $(".price").val();
                    var deposit = $(".deposit").val();
                    var cardFree = $(".mortgage_input").val();
                    // 修改data可以控制发送哪些携带数据。
                    data.category  = "其他";
                    data.sessionid = sessionid;
                    data.product_name = weui_textarea_1;
                    data.description = description;
                    data.price = price;
                    data.deposit = deposit;
                    data.cardFree = cardFree;
                });
            // 拖拽时不接受 js, txt 文件。
